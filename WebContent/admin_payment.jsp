...
String CHECKSUM_KEY = "Tn#]Mk;bpQ!=+[6";
String amtt;
if(amt1>=1000)
amtt="1000";
else
...
<input type="hidden" name="SUCCESSURL" value="http://localhost:8080/Bhamasha/payment_sucess.jsp" />
<input type="hidden" name="FAILUREURL" value="http://localhost:8080/Bhamasha/payment_fail.jsp" />
<input type="hidden" name="CANCELURL" value="http://localhost:8080/Bhamasha/payment_cancel.jsp" />
